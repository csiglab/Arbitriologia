...
> Money is a socially instituted, transferable, and universally, non ligaly binding accepted abstract claim—non-specific - on the output state of an economy (product and services) or on the futures ones.

> Money is fundamentally an **intertemporal coordinating medium** that links production, exchange, and claims across time, enabling the **continuous reproduction of an economy (products)**.
...
> **Currency** is the standardized monetary instrument issued within an economic system that functions as a transferable unit of account, medium of exchange, and store of value for pricing, settling, and transferring claims.

## QA

### What underlies the property of money that allows it to serve as a claim on future production? What sustains its purchasing power over time? What is the **limit** of this? How can money arise or should?

Some ideas for the answer:

- Surplus,
- New Money can arise - when we produce more - either by th invention of new technology - or the better used of current production resources ( labor, technical objects, etc ).
- Do we really need to increase the quantity of money in circulation?
...
### What underlies savings value?

> The value of your saved money is not guaranteed by a physical thing (like gold in a vault). It is guaranteed by the continued productive capacity of the economy and the discipline of the monetary system. The limit is when either production collapses or money creation runs wild.

> Money retains value only insofar as the productive system it coordinates continues to reproduce itself.

### What makes saving possible?

> Current saving is possible because the total amount of money can exceed the value of current goods available for purchase – but that's not a problem; it's the very definition of saving.

A Principle account:

- The existence of future production (or saved producs).
- The willingness of others to dissave or invest.
- A monetary system that allows money to be a store of value.

### How saved money works - when a local monetary area - interact with another?

> Savings held in a local currency become externally effective only through their convertibility into other monetary units. Their external value depends on the exchange ratio between the local currency and foreign currencies, which determines the quantity of foreign goods, services, or assets that those savings can command beyond the domestic monetary area.

> This puts a limit - on the claims that can be made on the other economy.
