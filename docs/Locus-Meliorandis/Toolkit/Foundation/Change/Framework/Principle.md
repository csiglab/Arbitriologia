...
How to thinkg abou tthe chang eint he techno produtive eocsystem?:

- How name the transicion from 'Estado de Suboptimalidad del Infra-Ecosistema-Tecnoproductivo' to 'Estado de Excelencia del Ecosistema Tecnoproductivo Relativo'?
- How name the transicion from 'Infra - Sustrato Tecnoproductivo' to 'Super - Sustrato Tecnoproductivo'?
- How name the transicion from 'Infra - Sustrato Tecnoproductivo' to 'Magno - Sustrato Tecnoproductivo'?
...
- Perfeccionismo: ...
- Evolucionismo: ...
- Virtuevolucionismo:  (Explorar libremente → detectar lo superior → conservarlo → escalarlo.)
- Optievolucionismo:   (Explorar libremente → detectar lo superior → conservarlo → escalarlo.)
